...
const Main = () => {
    return (
        <FadeIn>
            ...
            <section id="heritage" className="p-2 text-center high d-flex min-vh-100">
            ...
            <div class="jumbotron jumbotron-fluid text-center d-flex min-vh-100">
            ...
            <section id="redev" className="min-vh-100 d-flex text-center flex-column">
                <div className="container my-auto">
